...
for Cparam in Crange:
	for Gammaparam in gammaRange:
		bankdata = pd.read_csv("/Users/reza/Desktop/withoutFFI.unk")
		...
		filename = '/Users/reza/Desktop/withoutFFI.sav'
		...
		for i in range(0,8):
			...
			for bench in Benchmarks:
				if bench=="input":
					...
					filename="rr_arbiter"
				if i==0:
					addressOfFile="/Users/reza/Desktop/Thesis/RaveNOCVerilog/Infected/"+bench+"/"+filename+"WFFI.raw"
					addressOfFile1="/Users/reza/Desktop/Thesis/RaveNOCVerilog/Infected/"+bench+"/"+filename+".v"
				else:
					addressOfFile="/Users/reza/Desktop/Thesis/RaveNOCVerilog/Infected/"+bench+"/"+filename+str(i)+"WFFI.raw"
				...
				loaded_model = pickle.load(open("/Users/reza/Desktop/withoutFFI.sav", 'rb'))
